<?php
/*
 * Plugin Name: ulike123® SOA Emailer
 * Plugin URI: http://ulike123.co/double-opt-contact-form/
 * Description: Helps adding a precise Safe Harbor compliant, CRM alike Double Opt Contact Form to WP User's profile with .CO domains SOA seal.
...
/*  Copyright 2015  ulike123( ulike123.co )
...
?>
	...
	?>
		...
		<img alt="ulike123 SOA" style="margin: 0 3px 0 0; padding:0 3px 0 0;" src="http://ulike123.co/images/ulike123-barcode-seal.png" border="0" vspace="0" hspace="3px" />Accredited?! by ulike123&reg; SOA</u></a>
      <?php }
                if ( !$double_opt_contact_form_no_plugin_backlink ) {
	?>
	&nbsp;&nbsp;&nbsp;
		<a href="http://ulike123.co/double-opt-contact-form/" title="Visit this plugin's page.." target="_blank"><?php _e('Double Opt Contact Form', 'double_opt_contact_form_name'); ?></a>
	&nbsp;&nbsp;&nbsp;
	<?php }
	          if ( !empty( $double_opt_contact_form_header_html ) ) { echo $double_opt_contact_form_header_html; }
	?>
	</h3></td>
	</tr>
	<tr>
